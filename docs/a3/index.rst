...
.. tab:: 中文
    ...
    Gimp 和 Inkscape 是两个创建和操作二维图像的免费开源程序。Gimp 是一个绘画程序，主要关注于设置图像中各个像素的颜色。Inkscape 是一个绘图程序，它将图像表示为包含二维场景中对象信息的数据结构。绘画与绘图的区别在 :ref:`c1.1` 中进行了讨论。
...
.. tab:: 英文
    ...
    - Section 1: :ref:`Gimp: A 2D Painting Program <c.1>`
    - Section 2: :ref:`Inkscape: A 2D Drawing Program <c.2>`
