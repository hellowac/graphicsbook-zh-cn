...
.. tab:: 中文
    ...
    Blender 可以从 `blender.org <https://www.blender.org/>`_ 下载。该网站包含了大量关于它能做什么（ `blender.org/features <https://www.blender.org/features/>`_ ）以及如何使用它（ `blender.org/support <https://www.blender.org/support/>`_ ）的信息，包括在 `docs.blender.org <https://docs.blender.org/>`_ 上的详细用户手册。
...
.. tab:: 英文
    ...
    Blender can be downloaded from `blender.org <https://www.blender.org/>`_. The site includes a great deal of information about what it can do (`blender.org/features <https://www.blender.org/features/>`_) and how to use it (`blender.org/support <https://www.blender.org/support/>`_). including a detailed user manual at `docs.blender.org <https://docs.blender.org/>`_ .
    ...
    **Contents of Appendix B:**
    ...
    - Section 1: :ref:`Blender Basics <b.1>`
    - Section 2: :ref:`Blender Modeling <b.2>`
    - Section 3: :ref:`Blender Animation <b.3>`
    - Section 4: :ref:`More on Light and Material <b.4>`
